  ...
  return (
    <div className="min-h-screen bg-mesh flex items-center justify-center p-4">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-emerald-500/3 rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: '2s' }} />
      </div>
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gradient">Prosperas Reports</h1>
